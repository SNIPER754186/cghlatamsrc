...
if [[ ${pk} = "userMOD" ]]; then
	[[ $(uname -m 2> /dev/null) != x86_64 ]] && rm_rf="https://raw.githubusercontent.com/SNIPER754186/cghlatamsrc/main/CHUMOPLUS/mirror/github/main/BINARIOS/aarch64/add_new_user.bin" || local rm_rf="https://raw.githubusercontent.com/SNIPER754186/cghlatamsrc/main/CHUMOPLUS/mirror/github/main/BINARIOS/x86_64/add_new_user.bin"
